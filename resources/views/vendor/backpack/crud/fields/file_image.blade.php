...
<div data-preview="#{{ $field['name'] }}"
    ...
    <div class="row">
        <div class="col-sm-6" style="margin-bottom: 20px;">
            <a href="{{ url($image_url) }}" target="_blank" id="urlUpload">
                <img id="mainImage" src="{{ $image_url }}" style="max-height: 250px">
            </a>
        </div>
    ...
    <div class="btn-group">
        <label class="btn btn-primary btn-file">
            {{ trans('backpack::crud.choose_file') }} <input type="file" accept="image/*" id="uploadImage" name="{{ $field['name'] }}" @include('crud::inc.field_attributes', ['default_class' => 'hide'])>
        ...
        <script>
            ...
            jQuery(document).ready(function($) {
                ...
                $('.form-group.image').each(function(index){
                    ...
                    var $urlUpload = $(this).find("#urlUpload");
                        ...
                        if (/^image\/\w+$/.test(file.type)) {
                            ...
                            fileReader.onload = function () {
                                ...
                                if(crop){
                                    ...
                                    $urlUpload.attr('href',URL.createObjectURL(dataURItoBlob(this.result)));
