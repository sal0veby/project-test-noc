    ...
    @push('crud_fields_scripts')
        ...
        @if ($field_language !== 'en')
            <script charset="UTF-8"
                    src="{{ asset('vendor/adminlte/bower_components/bootstrap-datepicker/dist/locales/bootstrap-datepicker.'.$field_language.'.min.js') }}"></script>
            <script charset="UTF-8"
                    src="https://cdnjs.cloudflare.com/ajax/libs/moment.js/2.15.1/locale/{{$field_language}}.js"></script>
        @endif
        <script>
